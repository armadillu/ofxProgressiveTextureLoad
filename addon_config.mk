...
meta:
	ADDON_NAME = ofxProgressiveTextureLoad
	ADDON_DESCRIPTION = OpenFrameworks add-on to load textures progressively, across several frames, without blocking the app - with our without mipmaps.
	ADDON_AUTHOR = armadillu
	ADDON_TAGS = "ofTexture" "dynamic load"
	ADDON_URL = https://github.com/armadillu/ofxProgressiveTextureLoad
